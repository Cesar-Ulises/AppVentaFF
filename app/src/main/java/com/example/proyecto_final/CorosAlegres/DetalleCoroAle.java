...
public class DetalleCoroAle extends AppCompatActivity {
    TextView tv_titulo, tv_autor, tv_letra, tv_id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detalle_coro_ale);

        tv_id = findViewById(R.id.tv_idCale);
        tv_titulo = findViewById(R.id.tv_tituloCale);
